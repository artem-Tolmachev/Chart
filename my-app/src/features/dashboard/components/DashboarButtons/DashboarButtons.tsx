...
const DashboarButtons = ({ isOpen,  onClose}: Props) => {

    return (
        <>
            <div className={styles.options}>
                <div onClick={() => onClose('settings')} className={styles.filter}>
                ...
                <div onClick={() => onClose('add')} className={styles.filter}>
...
export default DashboarButtons;
