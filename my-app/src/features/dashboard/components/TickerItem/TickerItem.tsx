...
const TickerItem = ({ symbol, src, onClick, flag, deliteCoin }: Props) => {
                    ...
                    flag ?
                        <>
                            ...
                            className={`${styles.icon} ${styles.extraClass}`}>
                                <svg className={styles.del} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28">
                            ...
                            <span className={`${styles.icon} ${styles.extraClass}`}>
                        ...
                        <span className={`${styles.add} ${styles.extraClass}`}>
                            <svg className={styles.add} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28 28" width="28" height="28" fill="none"><path fill="" fill-rule="evenodd" clipRule="evenodd" d="M13.9 14.1V22h1.2v-7.9H23v-1.2h-7.9V5h-1.2v7.9H6v1.2h7.9z"></path>
                            </svg>
                        </span>
                }
            </div>
